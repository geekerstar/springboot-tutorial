package com.geekerstar.kafka.admin;
...
public class AdminSample {
    ...
    public final static String TOPIC_NAME="geek-topic";
...
//        AlterConfigsResult alterConfigsResult = adminClient.alterConfigs(configMaps);
    ...
    /*
        查看配置信息
        ConfigResource(type=TOPIC, name='geek-topic') ,
        Config(
            entries=[
             ConfigEntry(
...
//        ListTopicsResult listTopicsResult = adminClient.listTopics();
    ...
    public static AdminClient adminClient(){
        ...
        properties.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG,"192.168.0.100:9092");
