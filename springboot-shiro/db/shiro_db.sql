...
(
    255
) DEFAULT NULL COMMENT '说明',
    PRIMARY KEY
(
    `id`
),
    UNIQUE KEY ` UK_k3beff7qglfn58qsf2yvbg41i `
(
    `name`
)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(
    ...
    KEY ` FK74qx7rkbtq2wqms78gljv87a0 `
(
    `permission_id`
),
    KEY ` FKee9dk0vg99shvsytflym6egxd `
(
    `role_id`
),
    CONSTRAINT ` fk-p-rid ` FOREIGN KEY
(
    `role_id`
) REFERENCES ` pe_role `
(
    ...
    CONSTRAINT ` fk-pid ` FOREIGN KEY
(
    `permission_id`
) REFERENCES ` pe_permission `
(
    `id`
)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(
    ...
    KEY ` FK74qx7rkbtq2wqms78gljv87a1 `
(
    `role_id`
),
    KEY ` FKee9dk0vg99shvsytflym6egx1 `
(
    `user_id`
),
    CONSTRAINT ` fk-rid ` FOREIGN KEY
(
    `role_id`
) REFERENCES ` pe_role `
(
